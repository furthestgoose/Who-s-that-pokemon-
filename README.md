...
- [Windows x64](https://github.com/furthestgoose/Who-s-that-pokemon-/releases/download/v1.1.1/Who.s.That.Pokemon.1.1.1.win.zip).
- [MacOS](https://github.com/furthestgoose/Who-s-that-pokemon-/releases/download/v1.1.1/Who.s.That.Pokemon-1.1.1-arm64.dmg).<br>
...
```
- [Linux x64](https://github.com/furthestgoose/Who-s-that-pokemon-/releases/download/v1.1.1/Who.s.That.Pokemon-1.1.1.AppImage).
